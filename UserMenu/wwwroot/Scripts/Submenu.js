...
$(function () {
    ...
    $("#btnSubmit").click(function () {
        ...
        if (SubMenu == "") {
            ...
            GetPageErrorMsgByPageId(18, "009");
            return;
        }
        if (menuId=="") {
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "json",
            data: { submenuId: SubmenuId, subMenu: SubMenu, menuId: menuId, priority: Priority, PageUrl: PageUrl, status: status },
    ...
    function loadAdminDetails() {
        ...
        $('input[name=txtSubMenu]').prop('disabled', false);
    ...
    $(document).on('click', '.btnEditAdmin', function (e) {
       ...
       // $("#errEditLOSId").hide();
        ...
        GetMenu(dataItem.menuID, dataItem.menuName);
        ...
        $('input[name=txtSubMenu]').prop('disabled', true);
